      ...
      <main className="mx-auto flex max-w-6xl flex-col gap-6 px-6 py-12">
        <header className="flex flex-col gap-2">
          <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
            <h1 className="text-2xl font-semibold tracking-tight">Реестр рисков</h1>
            <a
        ...
        <section className="overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-sm dark:border-white/10 dark:bg-zinc-950">
          ...
          <div className="overflow-auto">
            <table className="min-w-[1100px] w-full text-left text-sm">
              ...
              <tbody>
                {rows.map((r) => (
                  <tr key={r.risk_code} className="border-t border-zinc-100 dark:border-white/10 align-top">
                ...
                {!loading && rows.length === 0 ? (
                  <tr>
                    <td className="px-6 py-10 text-sm text-zinc-500" colSpan={8}>
                      Нет данных.
                    </td>
                  </tr>
                ) : null}
